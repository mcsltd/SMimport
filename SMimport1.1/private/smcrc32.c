                  ...
                  int nrhs, const mxArray *prhs[])
{
    ...
    if (!mxIsInt8(prhs[0]) && !mxIsUint8(prhs[0]))
        mexErrMsgIdAndTxt("crc32:crc32", "Expected the input data to be a int8 or uint8 array");
    
    
    /* Calculate the checksum */
    unsigned char* pData =  (unsigned char *)(mxGetInt8s(prhs[0]));
    size_t length =  (unsigned int)mxGetNumberOfElements(prhs[0]);
    ...
    *(uint32_t *)mxGetUint32s(plhs[0]) = crc;
}